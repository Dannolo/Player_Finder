...
var Event = /** @class */ (function (_super) {
    ...
    function Event(id, name, slug, state, startAt, numEntrants, checkInBuffer, checkInDuration, checkInEnabled, isOnline, teamNameAllowed, teamManagementDeadline, videogamename) {
        ...
        _this.videogamename = videogamename;

        return _this;
    }
    Event.parse = function (data) {
        return new Event(data.id, data.name, data.slug, data.state, data.startAt, data.numEntrants, data.checkInBuffer, data.checkInDuration, data.checkInEnabled, data.isOnline, data.teamNameAllowed, data.teamManagementDeadline, data.videogame.name);
    };
