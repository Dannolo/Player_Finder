...
var Tournament = /** @class */ (function () {
    ...
    Tournament.prototype.getTourneyByGame = function (num) {
        return __awaiter(this, void 0, void 0, function () {
            var data, tourneyGames;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        Logger_1.default.info('Getting Tournaments for Videogames [%s :: %s]', num, this.name);
                        return [4 /*yield*/, NetworkInterface_1.default.query(queries.tournamentByVideogames, { videogameIds: [num]})];
                    case 1:
                        data = _a.sent();
                        tourneyGames = data;
                        return [2 /*return*/, tourneyGames];
                }
            });
        });
    };
